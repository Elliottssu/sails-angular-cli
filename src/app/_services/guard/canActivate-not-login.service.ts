...
export class AuthGuardNotLogin implements CanActivate, CanLoad {
    constructor(private router: Router, private utilService: UtilService, private userApiService: UserApiService) {
    ...
    checkLogin(url: string): boolean {
        ...
        //     return true
        // } else {
        //     this.userApiService.redirectUrl = url; //保留上一个页面的URL，登录完后可直接跳转
